...
export const Benefits = () => {
  return (
    <div className="flex flex-col space-y-6 items-center mt-4">
      ...
      <div className="flex flex-col w-full lg:w-none lg:max-w-none space-y-12 lg:space-y-0 lg:flex-row justify-center lg:space-x-10 items-center px-5 md:px-10 bg-ogray py-10">
